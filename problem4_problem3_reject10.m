...
originalID = ...
    bin2dec(char(OriginalStrategy)) + 1;
...
filename = ...
    'problem4_problem3_reject10_result.xlsx';
...
function p = generate_p_from_pool(pool,M)
